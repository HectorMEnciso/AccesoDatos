...
public class File_Random {
	public static void main(String[] args) throws IOException {
		...
		RandomAccessFile ficale = new RandomAccessFile(fic, "rw");// Se declara el fichero como de acceso aleatorio, para lectura y escritura ("rw")o para sólo lectura ("r")

		

		String apellido[] = { "Fernandez", "Gil", "Lopez", "Ramos", "Sevilla","Casilla", "Rey" };// Definimos los arrays con los datos. La longitud de cada registro es 36 bytes:
		int dep[] = { 10, 20, 10, 10, 30, 30, 20 };
		Double salario[] = { 1000.45, 2300.60, 3000.0, 1500.45, 1200.50,2500.90, 3000.00 };
